...
import com.marcus.materialescolar.db.dao.MarcaDao
import com.marcus.materialescolar.db.dao.MaterialDao
import com.marcus.materialescolar.model.Marca
 ...
 *
 */
@Database(entities = arrayOf(Material::class, Marca::class), version = 1)
